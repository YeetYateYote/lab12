...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            for (TreeNode child: children)
            {
            	...
            	TreeNode nonNull = child.getNodeWithName(targetName);
            	if(nonNull != null) {
            		return nonNull;
            	}
            }
	...
	private void addLine(String line) throws TreeException {
		...
		if (colonIndex < 0)
			throw new TreeException("Wrong Line Format: " + line);
		...
		else
		{
			...
			if(parentNode == null) {
				throw new TreeException("Parent node was not found: " + line);
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("Node was not found: " + name1);
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("Node was not found: " + name2);
